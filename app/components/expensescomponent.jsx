...
const Expenses = ({ transactions, setTransactions }) => {
    ...
    return (
        <div>
            <div className="flex justify-between flex-col bg-[#101622]">
                <div className="flex justify-between">
                    <div className=" px-12  font-semibold text-white text-2xl">Transaction History</div>
                    <button
                        type="button"
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-end space-x-2">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded ${isSubmitting ? "bg-gray-400" : "bg-purple-600"
